...
export const FETCHING_DIFF_COPY = "Fetching diff…"
export const NO_PREVIEW_FALLBACK = "(no preview)"
export const COMBINED_ERROR_HEADING = "Couldn't read this branch's diff"
export const COMBINED_ERROR_BODY =
  "GitHub didn't return a diff for this compare, and the page's file list wasn't available either. Try reloading the page."
